<?php
	...
	// upload to database
	$sql = "UPDATE colour_transmission_sessions SET enjoy=$enjoy, outreach=" . $db->quote($outreach) . 
	", comment=" . $db->quote($comment) . 
	" WHERE session_number=" . $db->quote($_SESSION['TwoColourCultra']["session_number"]) . ";";
